...
interface Q1<X> : SLRUMap<X> {
    <!WRONG_TYPE_PARAMETER_NULLABILITY_FOR_JAVA_OVERRIDE("X; fun takeV(x: X): Unit; fun takeV(value: X): Unit")!>override<!> fun takeV(x: X)
    <!WRONG_TYPE_PARAMETER_NULLABILITY_FOR_JAVA_OVERRIDE("E1; fun <E1> takeE(e: E1): Unit; fun <E : Any!> takeE(value: E): Unit")!>override<!> fun <E1> takeE(e: E1)
