...
internal class WasmUsefulDeclarationProcessor(
    ...
    globalFieldsInitializers: List<IrSetField>,
    ...
    private val fieldsToInitializers = globalFieldsInitializers.associateBy { it.symbol.owner }
    ...
    override fun processField(irField: IrField) {
        ...
        fieldsToInitializers[irField]?.value?.accept(bodyVisitor, irField)
    }
